...
extension UIColor {
    public static let themeYellowD = UIColor(hex: 0xB5C4FF)
    public static let themeYellowL = UIColor(hex: 0x005EFE)
    ...
    public static let themeYellow50 = UIColor(hex: 0x005EFE, alpha: 0.5)
    public static let themeYellow20 = UIColor(hex: 0x005EFE, alpha: 0.2)
